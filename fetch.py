#!/usr/bin/env python3
"""
Recupero codici sconto Maxi Sport da shopilo.it
Sursa: https://shopilo.it/negozi/maxisport.com
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/maxisport.com"
STORE_NAME = "Maxi Sport"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Maxi Sport da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-maxisport)"
    }
    try:
